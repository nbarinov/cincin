...
import type { ToasterOffset, ToasterPosition } from 'cincin-preact';
...
function App() {
  ...
  const [axes, setAxes] = useState<OffsetAxes>('vertical');
  const [clearance, setClearance] = useState<Clearance>({ x: 0, y: 0 });
