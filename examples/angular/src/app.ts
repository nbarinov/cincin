...
@Component({
  ...
  template: `
    <main>
      ...
      <p>
        The ready-to-use <code>&lt;cincin-toaster /&gt;</code> over the package
        singleton. Swipe a toast right or down, hover or tap the stack to expand
        it.
      </p>
      <section>
        @for (scenario of scenarios; track scenario[0]) {
          <button type="button" (click)="scenario[1]()">
            {{ scenario[0] }}
          </button>
        }
      </section>
