<img src="https://raw.githubusercontent.com/nbarinov/cincin/v0.3.0/.github/assets/hero-angular.png" alt="cincin-angular 🥂">
...
```html
<cincin-toaster [offset]="{ x: clearance().x, y: clearance().y }" />
```
...
and hand the input only what your page knows:

```ts
readonly clearance = signal(0);

// in the template
<cincin-toaster [offset]="clearance()" />
```

The input is sugar over two custom properties, `--cincin-offset-x` and
